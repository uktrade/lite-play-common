...
LITECommon.Modal = {
	...
	showModal: function(title, content) {
		...
		if (!$("#modal-background").length) {
			$("body").append("<div id='modal-background'><div id='modal'><div id='modal-aria-description' class='govuk-visually-hidden'>Press escape to close this popover</div><div id='modal-header'><a id='modal-back-button' class='govuk-link' href='#'>Back</a><a id='modal-close-button' class='govuk-link' href='#'>Close<span class='govuk-visually-hidden'> popover</span></a></div><div id='modal-contents'></div></div></div>")
